...
namespace CommsCheck.Benchmarks
{
    ...
    /// </summary>
    public class ClearableMemoryDistributedCache : IDistributedCache
    {
        ...
        public ClearableMemoryDistributedCache(IOptions<MemoryDistributedCacheOptions> optionsAccessor)
